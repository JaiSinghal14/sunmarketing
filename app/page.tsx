  ...
  return (
    <>
      <main className="min-h-screen bg-[#f3f4f6] px-4 sm:px-6 md:px-10 lg:px-16 pt-3 md:pt-4">
        ...
        {/* HERO SECTION */}
<section
  className="relative isolate grid grid-cols-1 md:grid-cols-2 items-center max-w-[1600px] mx-auto mt-4 md:mt-6 mb-10 sm:mb-14 md:mb-16 gap-8 md:gap-16 px-0 sm:px-4 md:px-10 py-2 sm:py-4 md:py-10 md:rounded-[32px] md:bg-gradient-to-b md:from-white/80 md:to-white/55 md:backdrop-blur-md md:border md:border-black/5 md:shadow-[0_24px_70px_rgba(0,0,0,0.06)]"
  aria-labelledby="hero-heading"
>

  {/* IMAGE */}
  <div className="order-2 md:order-1 w-full flex justify-center items-center md:translate-x-8 lg:translate-x-12 xl:translate-x-16">
    <Reveal>
      <Image
        src="/TSMA_NEW.png"
  ...
  {/* TEXT */}
  <div className="order-1 md:order-2 text-center md:text-left flex flex-col justify-center md:justify-start md:pt-1">
  ...
  <div className="flex animate-scroll gap-10 sm:gap-16 md:gap-20 w-max items-center">
    ...
    {[...Array(2)].map((_, i) => (
      <div key={i} className="flex gap-10 sm:gap-16 md:gap-20 items-center">
        ...
        <img src="/brands/mydreem.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/ertay.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/sr25.png" className="h-14 sm:h-16 md:h-24 lg:h-28 object-contain transition duration-300 hover:scale-110" />
        <img src="/brands/marko.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/meera.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/richberry.png" className="h-14 sm:h-16 md:h-24 lg:h-28 object-contain transition duration-300 hover:scale-110" />
        <img src="/brands/saras.png" className="h-14 sm:h-16 md:h-24 lg:h-28 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/hoppin.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/kaypee.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
  ...
  <div className="flex animate-scroll-reverse gap-10 sm:gap-16 md:gap-20 w-max items-center">
    ...
    {[...Array(2)].map((_, i) => (
      <div key={i} className="flex gap-10 sm:gap-16 md:gap-20 items-center">
        ...
        <img src="/brands/amal.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/madhur.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/ankit.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/panchwati.png" className="h-14 sm:h-16 md:h-24 lg:h-28 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/ausome.png" className="h-12 sm:h-16 md:h-20 lg:h-24 object-contain transition duration-300 hover:scale-110" />
        <img src="/brands/richbite.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/shivani.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/trang.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
        <img src="/brands/bunty.png" className="h-16 sm:h-20 md:h-28 lg:h-32 object-contain transition duration-300 hover:scale-125" />
...
/>
  ...
  <div className="relative bg-white rounded-[26px] sm:rounded-[35px] p-8 sm:p-10 md:p-14 shadow-[0_30px_80px_rgba(0,0,0,0.12)] z-10">
    ...
    <form className="space-y-4 sm:space-y-6" aria-label="Brand partner inquiry form">
      ...
      <button
        type="submit"
        className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg transition duration-300 shadow-lg hover:shadow-xl"
      >
        Submit Inquiry
      </button>
